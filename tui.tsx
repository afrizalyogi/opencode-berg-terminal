...
const tui: TuiPlugin = async (api) => {
  ...
  api.lifecycle.onDispose(offRoutes)
  api.lifecycle.onDispose(offKeys)
  api.lifecycle.onDispose(() => tracker.dispose())
  api.lifecycle.onDispose(() => offEvents.forEach((dispose) => dispose()))
  api.lifecycle.onDispose(offSessionUpdated)
}
